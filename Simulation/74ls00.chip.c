// Wokwi Custom Chip - 74LS00 Quad 2-Input NAND Gate
//
...
static void update_gate(pin_t pin_a, pin_t pin_b, pin_t pin_y) {
  ...
  // NAND Logic: Output is LOW (0) only if both inputs are HIGH (1)
  // Otherwise, Output is HIGH (1)
...
void chip_pin_change(void *user_data, pin_t pin, uint32_t value) {
  ...
  // Update all 4 gates whenever any input changes
...
void chip_init() {
  ...
  // Initialize ALL logic inputs with PULLUP for simulator stability
  ...
  // Outputs stay as standard OUTPUT
  ...
  // ... rest of your watcher code ...

  // Setup Watchers for all Input Pins
  ...
  printf("74LS00 Custom Chip Initialized!\n");
}